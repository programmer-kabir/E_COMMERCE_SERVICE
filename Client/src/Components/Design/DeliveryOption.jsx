...
const DeliveryOption = () => {
  return (
    <div className="w-full">
      <h2 className=" text-lg font-semibold primaryColor">Delivery Options</h2>
      <hr className="w-full" />
      {/*  */}
      <div className="mt-5 space-y-3">
        ...
        <div>
          ...
          <div className="text-red-700 font-medium space-y-2 pl-6 pt-2">
            <p>Delivery Time : 1-7 working days</p>
            <p>Shipping Charge : Free Shipping</p>
            <p>Free Shipping Over Order Amount Tk 150</p>
          </div>
        </div>
        {/* Cash */}
        <div>
